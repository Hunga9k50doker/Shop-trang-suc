...
export default function Product() {
  ...
  const { addProductToFavourite, favouriteState } = useContext(FavouriteContext);
        ...
        <div className="container">
                  ...
                  <React.Fragment key={id}>
                    <div className="row mb-4">
                      <div className="col col-xxl-6 col-xl-6 col-md-6 col-sm-12">
                        <div className="product__img">
                          ...
                          <div className="product__item__img">
                            <Zoom>
                              <img src={`../../images/${e.imgsUrl[pos]}`} alt="" />
                            </Zoom>
                          </div>
                        </div>
                      </div>
                      <div className="col col-xxl-6 col-xl-6 col-md-6 col-sm-12">
                        <div className="product__detail">
                          ...
                          <h6 className="product__desc mt-2 mb-2">{e.description}</h6>
                          <p className="product__price">Giá: {numberWithCommas(e.price)} vnđ</p>
                          <div className="product__add__cart">
                            <CountNumber quantity={quantity} setQuantity={setQuantity} />
                            <Button
                              onClick={() => {
                          ...
                          <div style={{ cursor: "pointer" }} className="product__add__wishlist">
                            <i ref={heartRef} className={favouriteState.products.find((p) => p._id === e._id) ? "bx bxs-heart" : "bx bx-heart"}></i>
                            {favouriteState.products.find((p) => p._id === e._id) ? (
                              <p className="ms-4 mt-4">
                                <Link to="/danh-sach-san-pham-yeu-thich/">Xem danh sách yêu thích của bạn</Link>
                              </p>
                            ) : (
                              <>
                                <p
                          ...
                          <ul className="product__other_desc ps-0">
                            <li className="ps-0">
                              ...
                              <p className="m-0 ms-2">Giá sản phẩm thay đổi tuỳ trọng lượng vàng và đá Đổi</p>
                            </li>
                            <li className="ps-0">
                              <i className="bx bxs-check-shield"></i>
                              <p className="m-0 ms-2">Sản phẩm trong 48h tại hệ thống cửa hàng Dimond City Miễn phí</p>
                            </li>
                            <li className="ps-0">
                              <i className="bx bxs-check-shield"></i>
                              <p className="m-0 ms-2">Giao nhanh Toàn Quốc 1-7 ngày</p>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="row">
                      ...
                      <ul className="row mb-5 accordion__list">
                        {reviews.map((r, id) => (
                          <li key={id}>
                            <div className="form__review__header" style={{ borderBottom: "1px solid #ccc" }}>
                              <i className="bx bxs-user"></i>
                              <p>{r.user[0].name ? r.user[0].name : r.user[0].username}</p>
                              <p style={{ float: "right" }}>{moment(r.createdAt).fromNow()}</p>
                            </div>
                            <p className="form__review__content">{r.description}</p>
                          </li>
                        ))}
                      </ul>
                      <textarea
                      ...
                      ></textarea>
                      <Button content="Thêm đánh giá" style={{ width: "fit-content" }} onClick={handleAddReview} />
                    </div>
                  </React.Fragment>
                )
            )}
          ...
          <div className="row">
            <div className="product__other">
              <div className="row ">
                <h4 className="product__other__title mt-5">Các sản phẩm khác</h4>
              </div>
              <div className="row mb-5">
                {proOther.map((e, id) => (
                  <div key={id} className="col col-xl-3 col-md-4 col-sm-6 col-12">
                    <Link
